  ...
  function MainController($interval, footballData, uiGridConstants) {
    ...
    vm.gridOptions = {
      ...
      columnDefs: [
        ...
        {name: 'Time', field: 'liveTime', width: 75, cellTemplate: '<div class="ui-grid-cell-contents red">{{COL_FIELD}}</div>'},
        {name: 'Home Team', field: 'teams[0].homeTeamName', cellTemplate: '<div class="ui-grid-cell-contents"><b>{{COL_FIELD}}</b></div>'},
        {name: 'Away Team', field: 'teams[1].awayTeamName', cellTemplate: '<div class="ui-grid-cell-contents"><b>{{COL_FIELD}}</b></div>'},
